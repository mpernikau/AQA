...
try:
    ...
    input4 = browser.find_element_by_css_selector('body > div > form > div.second_block > div.form-group.first_class > input')
    input4.send_keys("11111111")
    input5 = browser.find_element_by_css_selector('body > div > form > div.second_block > div.form-group.second_class > input')
